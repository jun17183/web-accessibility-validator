...
export default function Uploader() {
  return (
    <div className='flex w-full items-center gap-x-4 justify-center'>
      ...
      <Link
        to='/result'
        className='flex justify-center items-center h-14 w-24 min-w-20 px-5 py-2 bg-blue-500 font-semibold text-xl text-white rounded-full shadow-md shadow-slate-400 box-border'
      >
        Test
      </Link>
    </div>
