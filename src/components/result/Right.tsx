          ...
          selectedCode ? (
            <>
              ...
              <div className='code-block h-full my-2 p-8 bg-vscode-bg text-lg overflow-auto rounded-md'>
                {
                  description.map(item => <div className='text-white'>{`- ${item}`}</div>)
                }
              </div>
            </>
          ) : (
            <>
              ...
              <div className='flex items-center justify-center h-full my-2 bg-vscode-bg text-2xl text-center rounded-md'>
                <span className='text-white'>Please <span className='font-bold text-sky-400'>click on a highligted code</span> to see <br/> how it can be improved.</span>
              </div>
            </>
          )
        }
